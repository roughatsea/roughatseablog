...
The [Derveni Papyrus](https://www.unesco.org/en/memory-world/derveni-papyrus-oldest-book-europe) is an extraordinary collision of religion, philosophy, philology, and accident.
...
The machine included a water-balance escapement, part of the broader history of mechanisms that regulate the release of energy into repeated motion. A surviving technical account made later reconstruction possible; the [Science Museum Group](https://collection.sciencemuseumgroup.org.uk/objects/co894/scale-model-of-su-songs-water-balance-escapement) discusses a reconstruction of the escapement and its importance in the history of clockwork.
...
The *Yuktibhāṣā*, associated with Jyeṣṭhadeva and the Kerala mathematical tradition, preserves sophisticated reasoning about infinite series, trigonometric functions, and π. An accessible overview from the [Indian Academy of Sciences](https://www.ias.ac.in/article/fulltext/reso/017/02/0106-0115) describes the mathematical achievements of this tradition.
...
The goal was not merely storage. It was associative retrieval through spatial organization — something like walking through a constructed model of memory. [Cabinet](https://www.cabinetmagazine.org/issues/65/bolzoni.php) has a useful discussion of the project and its context.
...
Among Lunda-Cokwe and related traditions in Angola, **Sona** drawings combine geometric construction, storytelling, proverbs, riddles, memory, and cultural transmission. UNESCO recognizes [Sona drawings and geometric figures on sand](https://ich.unesco.org/en/RL/sona-drawings-and-geometric-figures-on-sand-01994) as intangible cultural heritage.
...
The [Lorsch Pharmacopoeia](https://media.unesco.org/sites/default/files/webform/mow001/germany_lorsch_pharmacopoeia.pdf), compiled around the age of Charlemagne, contains medicinal recipes but also something more philosophically revealing: a defense of medicine itself.
...
A [historical review in the medical literature](https://pmc.ncbi.nlm.nih.gov/articles/PMC5993855/) describes his quantitative experiments and instruments.
...
**Nüshu**, literally "women's writing," was a writing tradition used historically by women in Jiangyong County in Hunan, China. It was used in songs, letters, autobiographical material, and relationships between women, including sworn-sister traditions. UNESCO has written about [Nüshu and the lives preserved through it](https://courier.unesco.org/en/articles/nushu-tears-sunshine).
...
The [Stanford Encyclopedia of Philosophy](https://plato.stanford.edu/entries/mohist-canons/) treats them as major sources for early Chinese epistemology, logic, philosophy of language, and science.
...
The [Stanford Encyclopedia's overview of Jaina philosophy](https://plato.stanford.edu/entries/jaina-philosophy/) is a useful starting point.
...
He learned Sanskrit, engaged Indian scholars, and worked with Indian philosophical materials. [Encyclopaedia Iranica](https://www.iranicaonline.org/articles/biruni-abu-rayhan-index/biruni-abu-rayhan-viii/) discusses his Indian studies and translations.
...
Jonardon Ganeri's scholarly discussion of [Navya-Nyāya](https://www.columbia.edu/itc/mealac/pollock/sks/papers/Ganeri_NavyaNyaya%28SEP%29.pdf) describes the astonishing refinement of this tradition, including Gaṅgeśa's examination of numerous proposed definitions of the inference-grounding relation.
...
The Yoruba **Ifá** tradition combines divination, oral literature, ethics, interpretation, memory, and an enormous corpus of narratives associated with **256 Odù**. UNESCO recognizes the [Ifá divination system](https://ich.unesco.org/en/RL/ifa-divination-system-00146) as intangible cultural heritage.
...
The [Dresden Maya Codex](https://www.slub-dresden.de/en/explore/manuscripts/the-dresden-maya-codex/content) contains astronomical, mathematical, calendrical, ritual, and divinatory material that modern academic categories would distribute across several departments.
...
1. What does this unusual philosophical text argue?
2. Who actually wrote it?
...
1. **represent what they cannot directly grasp,**
2. **preserve what would otherwise disappear,** and
3. **correct for the unreliability of the minds doing the grasping.**
...
1. The Derveni Papyrus
2. The Banū Mūsā's *Book of Ingenious Devices*
3. Su Song's astronomical clock tower
4. The zā'irja
5. *Yuktibhāṣā* and the Kerala school
6. Giulio Camillo's Memory Theatre
7. Sona sand drawings
8. MONIAC, the hydraulic economic computer
...
3. The Badianus Manuscript
4. Ahmad Baba's *Miʿrāj al-Suʿūd*
5. Santorio Santorio's weighing experiments
6. Nüshu
7. Sangaku
8. Tupaia's Map
...
1. The Later Mohist Canons
2. Jain *anekāntavāda* and *syādvāda*
3. Al-Bīrūnī's *India*
4. Ibn Ṭufayl's *Hayy ibn Yaqẓān*
5. Gaṅgeśa's *Tattvacintāmaṇi* and Navya-Nyāya
6. The Ifá literary corpus
7. The Venus Tables of the Dresden Maya Codex
8. Zär'a Yaʿəqob's *Ḥatäta*
