...
1. **How abnormal is the result?** A tiny deviation and a massive deviation are not equivalent.
2. **Is it new?** A person's own baseline is often more informative than the population reference interval.
3. **Is it changing?** A rapidly rising creatinine, falling hemoglobin, or rising troponin may be more important than a stable abnormal value.
4. **Do related tests agree?** Physiologic explanations usually create patterns.
5. **Does the patient's history fit?** Symptoms, medications, recent illness, diet, surgery, pregnancy, and chronic disease matter.
6. **Could the specimen or measurement be misleading?** Hemolysis, contamination, delayed processing, IV-fluid contamination, and assay interference can all produce strange results.
7. **What would we expect to see elsewhere if the hypothesis were true?** This is where laboratory medicine begins to connect with ECGs, imaging, pathology, microbiology, and physical examination.

A useful mental model is:

$$
\text{Diagnosis} \neq \text{one laboratory value}
$$
...
\text{history}
+
\text{physical findings}
+
\text{laboratory patterns}
+
\text{time course}
+
\text{other diagnostic tests}
$$
...
1. What is happening with the **red blood cells** that carry oxygen?
2. What is happening with the **white blood cells** involved in immune defense?
3. What is happening with the **platelets** involved in clot formation?
...
1. How well is the kidney filtering? → **eGFR**
2. Is the filtration barrier damaged? → **urine albumin-to-creatinine ratio**
...
$$
\text{Globulin gap} = \text{Total protein} - \text{Albumin}
$$
...
- [MedlinePlus — Comprehensive Metabolic Panel (CMP)](https://medlineplus.gov/lab-tests/comprehensive-metabolic-panel-cmp/)
...
- [MedlinePlus — C-Reactive Protein](https://medlineplus.gov/lab-tests/c-reactive-protein-crp-test/)
...
- [MedlinePlus — D-Dimer Test](https://medlineplus.gov/lab-tests/d-dimer-test/)
- [MedlinePlus — Arterial Blood Gas Test](https://medlineplus.gov/lab-tests/arterial-blood-gas-abg-test/)
- [MedlinePlus — Anion Gap Blood Test](https://medlineplus.gov/lab-tests/anion-gap-blood-test/)
- [MedlinePlus — Methylmalonic Acid Test](https://medlineplus.gov/lab-tests/methylmalonic-acid-mma-test/)
- [MedlinePlus — Homocysteine Test](https://medlineplus.gov/lab-tests/homocysteine-test/)
- [MedlinePlus — MTHFR Gene Test](https://medlineplus.gov/lab-tests/mthfr-gene-test/)
- [CDC — MTHFR Gene Variant and Folic Acid Facts](https://www.cdc.gov/folic-acid/data-research/mthfr/index.html)
- [NIDDK — Identify and Evaluate Patients with Chronic Kidney Disease](https://www.niddk.nih.gov/health-information/professionals/clinical-tools-patient-management/kidney-disease/identify-manage-patients/evaluate-ckd)
...
- [American College of Medical Genetics and Genomics — Practice resources, including MTHFR guidance](https://www.acmg.net/ACMG/Medical-Genetics-Practice-Resources/Practice-Guidelines.aspx)
- [ACG Clinical Guideline — Evaluation of Abnormal Liver Chemistries (PubMed)](https://pubmed.ncbi.nlm.nih.gov/27995906/)
