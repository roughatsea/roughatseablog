...
$$
\text{measurement} \rightarrow \text{reference interval} \rightarrow \text{normal or abnormal}
$$
...
\text{trajectory}
+
\text{related measurements}
+
\text{pretest probability}
+
\text{measurement limitations}
+
\text{clinical context}
$$
...
1. The test measures a physiologically important phenomenon.
2. There is reasonable evidence connecting that measurement to clinically meaningful risk, diagnosis, prognosis, or treatment.
3. Major guidelines or expert bodies recognize its use in an identifiable population.
4. The information cannot always be recovered from the ordinary routine panel.
5. Knowing the result can plausibly alter a decision.
...
**Evidence anchor:** The 2026 ACC/AHA guideline recommends at least one Lp(a) measurement in adulthood and describes Lp(a) as a risk-enhancing factor. See the [American College of Cardiology summary of the 2026 dyslipidemia guideline](https://www.acc.org/about-acc/press-releases/2026/03/13/18/01/accaha-issue-updated-guideline-for-managing-lipids-cholesterol).
...
**Evidence anchor:** See the [American College of Cardiology's 2026 dyslipidemia guideline summary](https://www.acc.org/about-acc/press-releases/2026/03/13/18/01/accaha-issue-updated-guideline-for-managing-lipids-cholesterol).
...
$$
\text{aldosterone inappropriately high}
+
\text{renin suppressed}
$$
...
**Evidence anchor:** The [2025 Endocrine Society Clinical Practice Guideline on Primary Aldosteronism](https://www.endocrine.org/clinical-practice-guidelines/primary-aldosteronism-2) suggests screening all people with hypertension using aldosterone and renin, with potassium measured alongside them to aid interpretation.
...
**Evidence anchor:** The current global CKD standard remains the [KDIGO 2024 Clinical Practice Guideline for the Evaluation and Management of Chronic Kidney Disease](https://kdigo.org/guidelines/ckd-evaluation-and-management/), which emphasizes updated measurement of both estimated GFR and albuminuria.
...
**Evidence anchor:** KDIGO's 2024 CKD guideline incorporates modern use of creatinine, cystatin C, and combined equations when more accurate GFR assessment is needed. See [KDIGO CKD Evaluation and Management](https://kdigo.org/guidelines/ckd-evaluation-and-management/).
...
\mathrm{FIB\text{-}4}
=
\frac{\text{age} \times \text{AST}}
{\text{platelets} \times \sqrt{\text{ALT}}}
$$
...
**Evidence anchor:** See the American Association for the Study of Liver Diseases discussion of [noninvasive assessment in MASLD](https://www.aasld.org/liver-fellow-network/core-series/clinical-pearls/spare-me-jab-noninvasive-assessment-patients-masld).
...
**Evidence anchor:** The [AGA guideline on biomarkers in Crohn's disease](https://gastro.org/clinical-guidance/the-role-of-biomarkers-for-the-management-of-crohns-disease/) recommends combining biomarkers and symptoms and describes circumstances in which fecal calprotectin and CRP can help rule out active inflammation.
...
**Evidence anchor:** See the [ADA Standards of Care in Diabetes—2026: Diagnosis and Classification](https://diabetesjournals.org/care/article/49/Supplement_1/S27/163926/2-Diagnosis-and-Classification-of-Diabetes).
...
\text{drug exposure}
\rightarrow
\text{toxicity/efficacy risk}
\rightarrow
\text{prescribing decision}
$$

That is what actionable molecular medicine looks like.

**Evidence anchors:** CPIC maintains evidence-based guidance for [DPYD and fluoropyrimidines](https://cpicpgx.org/gene/DPYD/) and [TPMT/NUDT15 and thiopurines](https://cpicpgx.org/gene/NUDT15/). CPIC also explicitly states that its guidelines are generally designed to explain **how** available genetic results should be used rather than **whether** a test must be ordered; see [CPIC Guidelines](https://cpicpgx.org/%20guidelines/).
...
**Evidence anchor:** CLSI emphasizes that reference intervals are population- and method-dependent constructs rather than magical borders between health and disease. See [CLSI EP28: Defining, Establishing, and Verifying Reference Intervals](https://clsi.org/shop/standards/ep28/).
...
\text{abnormal TSH}
\rightarrow
\text{free T4 in the appropriate context}
$$

or:

$$
\text{elevated FIB\text{-}4}
\rightarrow
\text{elastography / ELF / further fibrosis assessment}
$$

or:

$$
\text{positive aldosterone-renin screen}
\rightarrow
\text{repeat / confirmatory strategy as appropriate}
\rightarrow
\text{subtype evaluation if treatment decisions require it}
$$

or:

$$
\text{unexplained monoclonal-protein signal}
\rightarrow
\text{immunofixation / free light chains}
\rightarrow
\text{hematologic evaluation}
$$
...
$$
\text{post-test probability}
=
 f(\text{test performance}, \text{pretest probability})
$$
...
2. Is the association with the clinical condition reproducible?
3. Does the result add information beyond what we already know?
4. Does it alter management?
5. Does acting on it improve meaningful outcomes?
6. What is the false-positive burden?
7. Is the interpretation validated in the population being tested?
...
\text{phenotype}
\rightarrow
\text{specific unanswered physiologic question}
\rightarrow
\text{targeted measurement}
\rightarrow
...
\text{patient}
\rightarrow
\text{order 200 biomarkers}
\rightarrow
\text{circle everything outside the range}
$$
...
- American College of Cardiology / American Heart Association. **2026 Guideline on the Management of Dyslipidemia.** Summary: [ACC/AHA Issue Updated Guideline for Managing Lipids, Cholesterol](https://www.acc.org/about-acc/press-releases/2026/03/13/18/01/accaha-issue-updated-guideline-for-managing-lipids-cholesterol).
- Endocrine Society. **Primary Aldosteronism: An Endocrine Society Clinical Practice Guideline.** July 2025: [Primary Aldosteronism](https://www.endocrine.org/clinical-practice-guidelines/primary-aldosteronism-2).
- Kidney Disease: Improving Global Outcomes. **KDIGO 2024 Clinical Practice Guideline for the Evaluation and Management of Chronic Kidney Disease:** [CKD Evaluation and Management](https://kdigo.org/guidelines/ckd-evaluation-and-management/).
- American Association for the Study of Liver Diseases. **Noninvasive Assessment of Patients with MASLD:** [Spare Me the Jab](https://www.aasld.org/liver-fellow-network/core-series/clinical-pearls/spare-me-jab-noninvasive-assessment-patients-masld).
- American Gastroenterological Association. **The Role of Biomarkers for the Management of Crohn's Disease:** [AGA Clinical Guidance](https://gastro.org/clinical-guidance/the-role-of-biomarkers-for-the-management-of-crohns-disease/).
- American Diabetes Association. **Standards of Care in Diabetes—2026: Diagnosis and Classification of Diabetes:** [Diabetes Care](https://diabetesjournals.org/care/article/49/Supplement_1/S27/163926/2-Diagnosis-and-Classification-of-Diabetes).
- Clinical Pharmacogenetics Implementation Consortium. **CPIC Guidelines:** [CPIC](https://cpicpgx.org/%20guidelines/).
- Clinical and Laboratory Standards Institute. **EP28: Defining, Establishing, and Verifying Reference Intervals in the Clinical Laboratory:** [CLSI EP28](https://clsi.org/shop/standards/ep28/).
- Clinical and Laboratory Standards Institute. **EP29: Expression of Measurement Uncertainty in Laboratory Medicine:** [CLSI EP29](https://clsi.org/shop/standards/ep29/).
