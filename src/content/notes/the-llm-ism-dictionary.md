...
1. **Lexicon** — Are AI-associated prestige words clustering?
2. **Syntax** — Are the same contrast and parallelism templates recurring?
3. **Structure** — Does every paragraph resolve with suspicious neatness?
4. **Tone** — Is the voice uniformly reasonable, helpful, and abstract?
5. **Texture** — Is there any idiosyncrasy, lived specificity, asymmetry, or unresolved mess?
